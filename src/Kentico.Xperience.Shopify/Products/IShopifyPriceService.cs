...
public interface IShopifyPriceService
{
    ...
    /// </summary>
    /// <param name="shopifyProductIds">Shopify product IDs.</param>
    ...
    public Task<IDictionary<string, ProductPriceModel>> GetProductsPrice(IEnumerable<string> shopifyProductIds, CountryCode countryCode);
}
