...
The development is currently in the first phase and the projects now only contains a product listing widget example, for displaying products from the E-Commerce platform (Shopify),
but the purchase itself still takes place on Shopify.
