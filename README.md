# Xperience by Kentico E-Commerce integrations
...
## Description
Repository contains solution with Xperience By Kentico integration to Shopify. It shows the connection to the Shopify headless API and shows the implementation of a simple e-shop on XByK (extended Dancing Goat sample site) using Shopify
...
6. If settings were not filled in the first step, go to Shopify configuration module in Xperience by Kentico admin page and fill the credentials.
Use this method only for development purposes! It is recommended to fill the credentials using User secrets(shown in the first step).
7. Add currency formats in the Shopify configuration module.
